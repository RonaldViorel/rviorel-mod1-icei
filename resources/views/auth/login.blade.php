        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="container image-container">
                    <img src="{{ asset('img/avatar.png') }}" width="180px" height="200px" alt="Tu Logotipo">
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" class="align-rigth">
                                    {{ __('Iniciar Sesion') }}
                                </button>
                            </div>
                        </div>
...
<style>
    .image-container {
        ...
        /* Agrega aquí tus estilos adicionales para el contenedor si es necesario */
    }
